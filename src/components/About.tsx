        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-lg shadow-lg p-4 hidden md:block">
                ...
                <div className="text-sm text-construction-gray">Lat doświadczenia</div>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-2xl md:text-3xl font-bold text-construction-navy mb-6">
              Kompleksowe rozwiązania budowlane na najwyższym poziomie
            </h3>
            <p className="text-construction-gray mb-8">
              Naszą misją jest zapewnienie klientom kompleksowej obsługi na każdym etapie procesu budowlanego. Specjalizujemy się w realizacji projektów mieszkaniowych i komercyjnych, oferując pełen zakres usług od wyszukania działki, przez budowę, aż po wykończenie wnętrz.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Zatrudniamy tylko wykwalifikowanych fachowców z udokumentowanym doświadczeniem'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Każdy projekt traktujemy indywidualnie, dostosowując się do potrzeb klienta'
                },
              ].map((item, index) => (
